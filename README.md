...
O modo online usa Supabase com autenticação anônima, presença por atividade, convites por código privado, grupos de até oito pessoas e regras RLS. Somente um apelido validado e o avatar escolhido são enviados ao Supabase depois da confirmação para entrar no Online. A confirmação vale apenas para a aba atual, links diretos de sala/grupo também passam pela orientação de segurança e o botão **Ficar offline** remove a presença imediatamente. Não existe diretório público: cada jogador compartilha seu código fora do site somente com um amigo conhecido.
